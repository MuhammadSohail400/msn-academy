...
export default function AuthLayout() {
  return (
    <div className="min-h-screen flex flex-col bg-slate-50/70 text-slate-900 py-4 sm:py-6 px-4 sm:px-6 lg:px-8">
      {/* Top Bar with Back to Website link */}
      <div className="w-full max-w-7xl mx-auto">
        <Link
          to="/"
          className="inline-flex items-center gap-2 text-xs sm:text-sm font-medium text-slate-400 hover:text-slate-700 transition-colors py-1 sm:py-2"
        >
      ...
      <div className="flex-1 flex flex-col items-center justify-center my-2 sm:my-3">
        {/* MSN Academy Navy Badge Logo */}
        <Link to="/" className="mb-3 sm:mb-4 flex flex-col items-center group">
